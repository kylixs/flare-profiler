 ...
 * @unrestricted
 */
Flamechart.EventsTimelineTreeView = class extends Flamechart.TimelineTreeView {
  /**
   * @param {!Flamechart.TimelineModeViewDelegate} delegate
   */
  constructor(delegate) {
    super();
    this._filtersControl = new Flamechart.EventsTimelineTreeView.Filters();
    this._filtersControl.addEventListener(
        Flamechart.EventsTimelineTreeView.Filters.Events.FilterChanged, this._onFilterChanged, this);
    this.init();
  ...
  updateContents(selection) {
    ...
    if (selection.type() === Flamechart.TimelineSelection.Type.TraceEvent) {
 ...
 * @unrestricted
 */
Flamechart.EventsTimelineTreeView.Filters = class extends Common.Object {
  constructor() {
    super();
    this._categoryFilter = new Flamechart.TimelineFilters.Category();
    this._durationFilter = new Flamechart.TimelineFilters.IsLong();
  ...
  populateToolbar(toolbar) {
    ...
    for (const durationMs of Flamechart.EventsTimelineTreeView.Filters._durationFilterPresetsMs) {
    ...
    /**
     * @this {Flamechart.EventsTimelineTreeView.Filters}
     */
  ...
  _notifyFiltersChanged() {
    this.dispatchEventToListeners(Flamechart.EventsTimelineTreeView.Filters.Events.FilterChanged);
  }
};

Flamechart.EventsTimelineTreeView.Filters._durationFilterPresetsMs = [0, 1, 15];

/** @enum {symbol} */
Flamechart.EventsTimelineTreeView.Filters.Events = {
