...
Flamechart.SimplePerformanceModel = class extends Common.Object {
  constructor() {
    super();
    /** @type {?SDK.Target} */
    ...
    this._frameModel =
        new TimelineModel.TimelineFrameModel(event => Flamechart.TimelineUIUtils.eventStyle(event).category.name);
    ...
    /** @type {!Flamechart.PerformanceModel.Window} */
  ...
  addExtensionEvents(title, model, timeOffset) {
    ...
    this.dispatchEventToListeners(Flamechart.PerformanceModel.Events.ExtensionDataAdded);
  }
  ...
  /**
   * @param {!Flamechart.PerformanceModel.Window} window
   * @param {boolean=} animate
   */
  setWindow(window, animate) {
    this._window = window;
    this.dispatchEventToListeners(Flamechart.PerformanceModel.Events.WindowChanged, {window, animate});
  }

  /**
   * @return {!Flamechart.PerformanceModel.Window}
   */
  window() {
    return this._window;
  }
